...
namespace ActiveDirectoryTest.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ActiveDirectoryTestConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ActiveDirectoryTestDbContext context)
        {
            _context = context;
        }
