...
{
    public abstract class ActiveDirectoryTestWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ActiveDirectoryTestWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ActiveDirectoryTestWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ActiveDirectoryTestDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ActiveDirectoryTestDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ActiveDirectoryTestDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ActiveDirectoryTestDbContext, Task<T>> func)
        {
            T result;
